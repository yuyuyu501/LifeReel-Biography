const labels = {
  ...
  PHOTO_REDRAW_NOT_CONFIGURED: "形象转绘服务尚未配置。",
  PHOTO_REDRAW_FAILED: "本章形象转绘失败。",
  PHOTO_REDRAW_REJECTED: "本章形象未通过转绘平台审核。",
  PHOTO_REDRAW_UNCERTAIN: "本章形象转绘结果待确认。",
  PHOTO_REDRAW_SOURCE_INVALID: "本章形象素材已变化，请重新生成。",
  PHOTO_REDRAW_RESULT_INVALID: "本章形象转绘结果无效。",
