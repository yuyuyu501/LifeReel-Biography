const labels = {
  ...
  preparing_references: "准备本章形象",
  VIDEO_AUDIO_REFERENCE_INVALID: "参考音频时长不符合要求，请修改本章形象素材。",
  VIDEO_AUDIO_REQUIRES_IMAGE: "音频参考需搭配图片，请在本章形象栏补充图片。",
  PHOTO_REDRAW_NOT_CONFIGURED: "形象标注服务尚未配置。",
  PHOTO_REDRAW_FAILED: "本章形象标注失败。",
  PHOTO_REDRAW_REJECTED: "本章形象未通过图片平台审核。",
  PHOTO_REDRAW_UNCERTAIN: "本章形象标注结果待确认。",
  PHOTO_REDRAW_SOURCE_INVALID: "本章形象素材已变化，请重新生成。",
  PHOTO_REDRAW_RESULT_INVALID: "本章形象标注结果无效。",
