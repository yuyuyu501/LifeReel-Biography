export const ERROR_MESSAGES: Record<string, string> = {
  PHOTO_REDRAW_NOT_CONFIGURED: "照片转绘暂未启用。",
  PHOTO_REDRAW_SOURCE_INVALID: "请使用已授权的原始 PNG、JPEG 或 WebP 照片，大小不超过 10 MB。",
  PHOTO_REDRAW_FAILED: "照片转绘失败，请稍后重试。",
  PHOTO_REDRAW_REJECTED: "服务商未接受此照片转绘请求，请核对素材和使用权限。",
  PHOTO_REDRAW_UNCERTAIN: "转绘请求已中断，服务商可能已计费。重新转绘可能产生新的费用。",
  PHOTO_REDRAW_RESULT_INVALID: "转绘结果无效或未完整保存，请稍后重试。",
  ...
  AUTH_INVALID_CREDENTIALS: "账号或密码不正确，或账号已停用。",
