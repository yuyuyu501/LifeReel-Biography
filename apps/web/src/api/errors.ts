export const ERROR_MESSAGES: Record<string, string> = {
  PHOTO_REDRAW_NOT_CONFIGURED: "照片标注暂未启用。",
  PHOTO_REDRAW_SOURCE_INVALID: "请使用已授权的原始 PNG、JPEG 或 WebP 照片，大小不超过 10 MB。",
  PHOTO_REDRAW_FAILED: "照片标注失败，请稍后重试。",
  PHOTO_REDRAW_REJECTED: "服务商未接受此照片标注请求，请核对素材和使用权限。",
  PHOTO_REDRAW_UNCERTAIN: "标注请求已中断，服务商可能已计费。重新标注可能产生新的费用。",
  PHOTO_REDRAW_RESULT_INVALID: "标注结果无效或未完整保存，请稍后重试。",
